...
class SchoolStudyroom : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.school_studyroom)
        ...
        db.collection("users").document(userId)
            ...
            .addOnSuccessListener {
                Log.d("SchoolStudyroom", "用戶狀態已設置為 active")
            }
            .addOnFailureListener { e ->
                Log.e("SchoolStudyroom", "無法設置用戶狀態", e)
        ...
        Log.d("SchoolStudyroom", "當前用戶 ID: $userId")
        ...
        db.collection("users")
            ...
            .addOnSuccessListener { documents ->
                if (documents.isEmpty) {
                    Log.w("SchoolStudyroom", "沒有用戶在自習室")
                ...
                for (document in documents) {
                    ...
                    if (characterId == null) {
                        Log.w("SchoolStudyroom", "無效的 character ID: $characterIdString")
                        continue
                    }
    ...
    private fun updateFirestoreStatusAndLog(
        ...
        db.collection("users").document(userId)
            ...
            .addOnSuccessListener {
                Log.d("SchoolStudyroom", "用戶狀態已成功更新為離開")
                Toast.makeText(this, "已退出自習室", Toast.LENGTH_SHORT).show()
                finish() // 返回上一頁
            }
            .addOnFailureListener { e ->
                Log.e("SchoolStudyroom", "更新用戶狀態失敗", e)
